## coffee_hash.class decompilato con decompiler.com
from z3 import *
...
hash = "630:624:622:612:609:624:623:610:624:624:567:631:638:639:658:593:546:605:607:585:648:636:635:704:702:687:687:682:629:699:633:639:634:637:578:622:620:617:606:615:568:633:589:587:645:639:653:654:633:634".split(":")

sistema = Solver()

fs = [Int(f"f[{i}]") for i in range(50)]

for i in range(len(hash)):
   print(fs[i])
   print(f"{fs[i]} == {fs[((i+7)%50)]} + ({int(hash[i])-int(hash[(i+1)%50])})")
   sistema.add(fs[i] == fs[(i+7)%50] + (int(hash[i])-int(hash[(i+1)%50])),fs[i]>=48,fs[i]<=125)
   
print(sistema.check())
solved = sistema.model()

for i in range(len(solved)):
   print(chr(solved[fs[i]].as_long()),end="")